...
python code/may_9_gen_en.py --model_name llama-13b --altering _rotate_two_part --lan en
sleep 180
python code/may_9_gen_en.py --model_name llama-30b --altering _rotate_two_part --lan en
#sleep 180
